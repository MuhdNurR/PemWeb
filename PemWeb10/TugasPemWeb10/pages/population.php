                        ...
                        <div class="col-sm-7">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Top 10 Bar Chart By Total Population
                                    <p>
                        ...
                        <div class="col-sm-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Top 10 Pie Chart By Total Population</p>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Top 10 Line Chart By Total Population
                                    <p>
                                    <div class="mb-5" style="width: 100%;">
