...
while ($row = mysqli_fetch_array($produk)) {
    ...
    $query = mysqli_query($koneksi, "select sum(total_deaths) as total_deaths from tb_covid_asia where id='" . $row['id'] . "'");
    $row = $query->fetch_array();
    $jumlah_penderita[] = $row['total_deaths'];
}
?>
                        ...
                        <div class="col-sm-7">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Top 10 Bar Chart By Total Death
                                    <p>
                        ...
                        <div class="col-sm-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Top 10 Pie Chart By Total Death</p>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Top 10 Line Chart By Total Death
                                    <p>
                                    <div class="mb-5" style="width: 100%;">
