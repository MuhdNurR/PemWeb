    ...
    <div class="container border border-3 mb-5 border-dark" style="background-color:white; border-radius:25px;">
        <form action="" method="post">
            ...
            <div class="row mb-3 mt-3">
                ...
                <div class="col-md-8">
                    <div class="form-check form-check-inline ">
                        <input type="radio" class="form-check-input" id="kewarganegaraan" name="kewarganegaraan" value="Warga Negara Indonesia" required>
                        <label class="form-check-label" for="kewarganegaraan">Indonesia</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="kewarganegaraan" name="kewarganegaraan" value="Warga Negara Asing" required>
