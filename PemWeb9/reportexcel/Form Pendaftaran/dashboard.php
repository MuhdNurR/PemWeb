...
<body id="body-pd">
    ...
    <div class="height-100">
        ...
        if (isset($_SESSION['daftar'])) {
            echo '<a href="form1.php"><button type="button" class="btn btn-primary">Daftar Sekarang</button></a>';
        } else {
            echo '<a href="form1.php"><button type="button" class="btn btn-primary disabled">Daftar Sekarang</button></a><br>';
        }
        ?>
